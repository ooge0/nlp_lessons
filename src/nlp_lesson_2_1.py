...
def go(house, rock, attr):
    ...
    out_hidden = np.array([act(x) for x in sum_hidden]) # "пропускаем" вектор суммы весов скрытого слоя через функцию активациию так получаем вектор с каждого нейрона скрытого слоя.
